...
public class PreviousProgressDetails {
	...
	public PreviousProgressDetails(int gradeId, String grade, Date date, int studentId, int adminId) {
		super();
	...
	public PreviousProgressDetails(String grade, Date date, int studentId, int adminId) {
		super();
		this.grade = grade;
		this.date = date;
		this.studentId = studentId;
